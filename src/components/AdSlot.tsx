 ...
 */
export function AdSlot({ type = "adsense", slot = "inArticle", label, className = "", height = 100 }: AdSlotProps) {
...
export function StickyMobileAd() {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background/95 backdrop-blur md:hidden">
      <AdSlot type="adsense" slot="stickyMobile" label="Sticky mobile" height={60} className="my-0" />
    </div>
  );
}
