...
const SOCIALS = [
  { name: "Facebook", url: "https://web.facebook.com/kamusnias", icon: Facebook, color: "hover:bg-[#1877F2]" },
  { name: "Instagram", url: "https://www.instagram.com/kamusniasorid", icon: Instagram, color: "hover:bg-gradient-to-br hover:from-[#F58529] hover:via-[#DD2A7B] hover:to-[#8134AF]" },
  { name: "X (Twitter)", url: "https://x.com/kamusniascom", icon: XIcon, color: "hover:bg-black" },
  { name: "Pinterest", url: "https://id.pinterest.com/kamusnias", icon: PinterestIcon, color: "hover:bg-[#E60023]" },
  { name: "LinkedIn", url: "https://www.linkedin.com/in/kamusnias/", icon: Linkedin, color: "hover:bg-[#0A66C2]" },
] as const;
