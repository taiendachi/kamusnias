    ...
    <Layout>
      ...
      <section className="mx-auto max-w-6xl px-4 py-8">
        ...
        <p className="mt-4 text-center text-xs text-muted-foreground">
          Gunakan kotak pencarian di atas untuk menemukan kata lainnya dari total {entries.length.toLocaleString("id-ID")} kata.
        </p>
        <noscript className="mt-2 block text-center text-xs">Aktifkan JavaScript untuk menggunakan pencarian.</noscript>
