    ...
    <Layout>
      <article className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="prose prose-sm mt-6 max-w-none text-foreground/90 md:prose-base">
          <p>
            <strong>{SITE.longName}</strong> hadir sebagai upaya digital untuk
            mendokumentasikan, melestarikan, dan menyebarluaskan Bahasa Nias atau
            <em> Li Niha</em>. Kami percaya bahwa bahasa daerah adalah warisan
            yang harus tetap hidup di tengah modernisasi.
          </p>
          ...
          <ul className="ml-5 list-disc space-y-1">
            ...
            <li>Menjadi rujukan digital terbuka untuk peneliti, pelajar, dan pencinta budaya Nias.</li>
          ...
          <p>
            Untuk pelajar, mahasiswa, peneliti bahasa, perantau Nias yang ingin
            kembali ke akar bahasanya, serta siapa pun yang tertarik mengenal
            kekayaan Bahasa Nias (Li Niha).
          </p>

          <h2 className="mt-8 font-serif text-2xl font-bold">Sumber Data</h2>
          <p>
            Data kosakata dikelola melalui basis data terbuka yang terus diperbarui.
            Kami mengundang penutur asli dan kontributor untuk menambahkan,
            memperbaiki, atau mengusulkan kosakata baru melalui
            <a href="/saran" className="text-primary hover:underline"> Form Saran</a>.
          </p>

          <h2 className="mt-8 font-serif text-2xl font-bold">Dukungan</h2>
          <p>
            {SITE.longName} dijalankan secara non-komersial. Dukungan Anda — melalui
            saran kata, berbagi tautan, atau donasi sukarela di halaman
            <a href="/support" className="text-primary hover:underline"> Dukung Kami</a> —
          ...
          <p>
            ...
            atau melalui halaman <a href="/kontak" className="text-primary hover:underline">Kontak</a>.
          </p>

          <p className="mt-10 italic text-muted-foreground">Ya'ahowu — Salam berkah dari Tano Niha.</p>
        </div>
